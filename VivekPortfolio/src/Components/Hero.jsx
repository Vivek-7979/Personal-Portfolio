...
function Hero() {
  ...
  return (
    <section id='hero' className='w-full min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-10 mt-25'>
      <div className='flex w-[90%] max-w-310 items-center justify-between gap-8 max-[800px]:flex-col max-[800px]:justify-center max-[800px]:text-center max-[800px]:gap-6'>
          ...
          <div className='mt-6 flex flex-wrap items-center gap-3 '>
            <a href="#projects">
              <button
                ...
                className='rounded-full border border-white/40 bg-transparent px-5 py-2.5 text-sm font-medium text-white transition duration-300 hover:border-white/60 hover:bg-white/15 sm:px-6 sm:py-3 sm:text-[15px]'
              >
                View My Work
              </button>
            </a>
            ...
            <button
              ...
              style={{ cursor: 'pointer', filter: 'drop-shadow(0 0 10px rgba(148, 163, 184, 0.75))' }}
              className='inline-flex items-center gap-4 rounded-full border border-white/40 bg-transparent px-5 py-2.5 text-sm font-medium text-white transition duration-300 hover:border-white/60 hover:bg-white/15 sm:px-6 sm:py-3 sm:text-[15px]'
            >
              <span>Download My Resume</span>
              <img
                src={resume}
                alt='Resume icon'
                className='h-4 w-4 inline-block brightness-0 invert sm:h-5 sm:w-5'
                loading='lazy'
                decoding='async'
              />
            </button>
        ...
        <div className='flex flex-col items-center justify-center max-[800px]:mt-2'>
          <img
            src={profile}
            alt='Vivek Kumar profile portrait'
          ...
          <div className='mt-5 flex items-center justify-center gap-4 sm:gap-7 md:gap-10'>
            <button
              type='button'
            ...
            >
              <img
                src={githubicon}
                alt='GitHub'
                className='h-7 w-7 cursor-pointer brightness-0 invert drop-shadow-[0_0_10px_rgba(148,163,184,0.5)] sm:h-9 sm:w-9 md:h-10 md:w-10 max-[400px]:h-7 max-[400px]:w-7'
                loading='lazy'
                decoding='async'
              />
            </button>
            ...
            >
              <img
                src={linkdeinicon}
                alt='LinkedIn'
                className='h-7 w-7 cursor-pointer drop-shadow-[0_0_10px_rgba(148,163,184,0.5)] sm:h-9 sm:w-9 md:h-10 md:w-10 max-[400px]:h-7 max-[400px]:w-7'
                loading='lazy'
                decoding='async'
              />
            </button>
